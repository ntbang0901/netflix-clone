          ...
          <div className="absolute bottom-10 flex w-full items-center justify-between px-10">
            <div className="flex space-x-2">
              ...
              <button className="modal-btn">
                {muted ? (
                  <CheckIcon className=" w-4 h-4  md:h-7 md:w-7" />
                ) : (
                  <PlusIcon className="w-4 h-4  md:h-7 md:w-7" />
                )}
              </button>

              <button className="modal-btn">
                <HandThumbUpIcon className="w-4 h-4  md:h-7 md:w-7" />
              </button>
            </div>
            <button className="modal-btn" onClick={() => setMuted(!muted)}>
              {muted ? (
                <SpeakerXMarkIcon className="w-4 h-4  md:h-7 md:w-7" />
              ) : (
                <SpeakerWaveIcon className="w-4 h-4  md:h-7 md:w-7" />
              )}
            </button>
          </div>
        </div>
